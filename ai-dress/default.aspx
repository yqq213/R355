<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="//at.alicdn.com/t/c/font_4789865_lvrrk40mz4.css"
    />
    <!-- 引入防xss攻击js -->
  ...
  <body>
    <div class="header flexBetween">
      ...
      <div class="right" onclick="window.location.href='/member/buyPoint.aspx'">
        <span class="title">我的作品</span>
        <img src="/images/ai-dress/invite-btn.png" class="invite-btn" />
        <div class="charge-btn">5698</div>
      </div>
    </div>
    <div class="ai-content">
          ...
          <div class="task-list">
            <li class="task-item">
              <a href="default.aspx?ID=0"
                ><div class="create flexCenter">继续创建</div></a
              >
            </li>
            <li class="task-item active" data-id="15">
              <a href="default.aspx?ID=15"
                ><img src="/hwtastImg/20250112/RX680TV8R2J268404J.jpg"
              /></a>
            </li>
            <li class="task-item" data-id="13">
              <a href="default.aspx?ID=13"
                ><img src="/hwtastImg/20250112/RX680TV8R2J268404J.jpg"
              /></a>
            </li>
            <li class="task-item" data-id="12">
              <a href="default.aspx?ID=12"
                ><img src="/hwtastImg/20250112/RX680TV8R2J268404J.jpg"
              /></a>
            </li>
          </div>
      ...
      <div class="content-center">
        <!-- 生成结果 -->
        <div class="ai-result">
          <div><p class="title">生成结果</p></div>
          <div class="result-empty flexCenter" style="display: none">
            <div class="result-pannel flexCenter">AI生图 服装上身</div>
            <p class="label">
              可轻松生成不同姿态的模特图，使用教程详见上方视频
            </p>
            <p class="tip">
              小贴士：如何生成不同模特和场景的商品平铺图？ 去看看<span
          ...
          <div class="result-wrap">
            <div class="result-tip">
              ...
              <p id="addtime">任务ID：19633283 2025/1/13 10:36:13</p>
            </div>
            <div class="result-container">
              <div class="result-item">
                <div class="refer">
                  <img
                    src="http://www.r355.com/sceneImg/20250101/202501012155312861866.jpg"
                  /><span class="label flexCenter">参考图1</span>
                </div>
                <div class="item">
                  <a
                    href="/hwtastImg/20250113/task_202501131038120921419.jpg"
                    target="_blank"
                    ><img
                      src="http://www.r355.com/sceneImg/20250101/202501012155312861866.jpg"
                  />
                    <div class="result-item-shadow flexCenter">
      ...
      <div class="content-right">
        <div class="flexBetween main-title">
          ...
          <img src="/images/ai-dress/couse-icon.png" alt="" />
          <span>教程</span>
        ...
        <div class="btn-tabs">
          <div
            data-bili="1"
            class="tab flexCenter first active"
        ...
        <div class="dress-tabs">
          <img
            src="/images/ai-dress/back-border-icon.png"
            style="margin-right: 5px"
          />
          <span class="label">图片规则</span>
          <div class="tab active" data-type_id="1" style="margin-right: 20px">
            单件上身
          </div>
        ...
        <div class="upload-area single">
          <div class="upload-item">
            <select name="sel_cat_id" id="sel_cat_id" class="uplaod-select">
              <option selected="selected" value="1">上装</option>
        ...
        <div class="upload-area multi shangzhuang" style="display: none">
          <div class="upload-item" style="margin-right: 10px">
            <div class="flexCenter upload-empty">
              <img src="/images/ai-dress/upload-dress-icon.png" alt="" />
              <p style="margin: 10px 0 10px 0">上传上装平铺图</p>
              <p class="tip">图片大小50K-2M</p>
        ...
        <input
          type="hidden"
          value="/hwtastImg/20250112/RX680TV8R2J268404J.jpg"
        ...
        <div class="upload-model-empty flexBetween">
          ...
          <div class="select-values">
            ...
            <div class="select-btns" style="display: none">
              ...
              <input type="hidden" id="scene_id" value="22071232366" />
            </div>
          </div>
        ...
        <div class="func-wrap">
          ...
          <span
            data-auto_hand_refine="1"
            class="iconfont icon-kaiguanguan"
          ></span>
          <span
            data-auto_hand_refine="0"
            class="iconfont icon-kaiguankai"
            style="display: none"
          ></span>
        ...
        <div class="bottom-wrap">
          ...
          <div class="btn flexCenter generateBtn">
            ...
            <span class="cost flexCenter">
              <img
                src="/images/ai-dress/coin-icon.png"
                style="margin-right: 5px"
              />
    ...
    <input type="hidden" id="_id" value="15" />
    <input type="hidden" id="task_status" value="4" />
    <input
      name="scene_img"
      type="hidden"
      id="scene_img"
      value="/sceneImg/20250101/202501012155312861866.jpg"
    />
    <input
      name="scene_text"
      type="hidden"
      id="scene_text"
      value="已选“【3:4】女士-衬衫”等1张"
    />
    <input name="scene_num" type="hidden" id="scene_num" value="1" />
    <input name="user_point" type="hidden" id="user_point" value="30" />
  </body>
  <script src="/js/jquery.pagination.js"></script>
  <script src="/js/ai-dress.js"></script>
</html>
