...
!(function (i) {
  ...
  (u.prototype = {
    ...
    view: function (t) {
      ...
      (t = Number(t) || 0),
        !this.isShown ||
          ...
          h.empty(),
          console.log(n),
          this.doAjax(n.attr('src'), n.attr('PID')),
          this.$element.one(
            K,
            i.proxy(function () {
              var i = this.image,
          ...
          ((t = i.proxy(function () {
            this.playing = setTimeout(function () {
              a[r].removeClass(F),
                ...
                a[r].addClass(F),
                // 自动播放时将图片url传给后端
                // i.proxy(this.doAjax(a[r].attr('src'), a[r].attr('PID')), this)
                that.doAjax(a[r].attr('src'), a[r].attr('PID')),
                t();
            }, s.interval);
          }, this)),
          h > 1 && t()));
    ...
    (u.TEMPLATE =
      '<div class="viewer-container"><div class="viewer-canvas" data-action="mix"></div><div class="viewer-footer"><div class="viewer-title"></div><ul class="viewer-toolbar"><li class="viewer-zoom-in" data-action="zoom-in"></li><li class="viewer-zoom-out" data-action="zoom-out"></li><li class="viewer-one-to-one" data-action="one-to-one"></li><li class="viewer-reset" data-action="reset"></li><li class="viewer-prev" data-action="prev"></li><li class="viewer-prev left_btn" data-action="prev"></li><li class="viewer-play" data-action="play"></li><li class="viewer-next" data-action="next"></li><li class="viewer-next right_btn_1" data-action="next"></li><li class="viewer-rotate-left" data-action="rotate-left"></li><li class="viewer-rotate-right" data-action="rotate-right"></li><li class="viewer-flip-horizontal" data-action="flip-horizontal"></li><li class="viewer-flip-vertical" data-action="flip-vertical"></li></ul><div class="viewer-navbar"><ul class="viewer-list"></ul></div></div><div class="viewer-tooltip"></div><div class="viewer-button" data-action="mix"></div><div class="viewer-player"></div></div>'),
    (u.other = i.fn.viewer),
