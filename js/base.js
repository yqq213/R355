...
//客服
$(document).ready(function(){$(".li1").hover(function(){$(".show_a").fadeToggle(100)});$(".li2").hover(function(){$(".show_b").fadeToggle(100)});$(".li3").hover(function(){$(".show_c").fadeToggle(100)});$(".li5").hover(function(){$(".show_d").fadeToggle(100)})});$(".li7").click(function(){$('body,html').animate({scrollTop:0},500)})
...
lnk.data('page_id',page_id);return lnk;},appendRange:function(container,current_page,start,end,opts){var i;for(i=start;i<end;i++){this.createLink(i,current_page,opts).appendTo(container);}},getLinks:function(current_page,eventHandler){var begin,end,interval=this.pc.getInterval(current_page),np=this.pc.numPages(),fragment=$("<span class='pagination'></span>");if(this.opts.prev_text&&(current_page>0||this.opts.prev_show_always)){fragment.append(this.createLink(current_page-1,current_page,{text:this.opts.prev_text,classes:"prev"}));}
...
$(function() {
    $(".selectBox .imitationSelect").on("click",
    function(event) {
...
function checkLetter(lt) {
    ...
    if (str_val < 0) {
        ...
        var parent = $('#check_' + lt.substr(0, 1).toUpperCase()).parent().attr('id');
