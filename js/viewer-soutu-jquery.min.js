...
function(i) {
	...
	u.prototype = {
		...
		play: function() {
		    var t, s = this.options,that = this,
			n = this.$player,
		    ...
		    this.isShown && !this.isPlayed && (s.fullscreen && this.requestFullscreen(), this.isPlayed = !0, n.addClass(b), this.$items.each(function(t) {
		        ...
		        that.doAjax(l[r].attr('alt'), l.data("originalUrl"));
				var d = i('<img src="' + l.data("originalUrl") + '" alt="' + l.attr("alt") + '">');
				h++,
